...
def splitDataSet(self, features: ndarray, targets: ndarray, splitRatio: list[float], logging:bool = False):
    """
    ...
    logging and print(f"Split ratios: {splitRatio[0]*100}% for training, {splitRatio[1]*100}% for evaluation and {splitRatio[2]*100}% for testing")
    logging and print(f"x_train: {x_train.shape} \n x_eval: {x_eval.shape} \n x_test: {x_test.shape} \n y_train: {y_train.shape} \n y_eval: {y_eval.shape} \n y_test: {y_test.shape}")
